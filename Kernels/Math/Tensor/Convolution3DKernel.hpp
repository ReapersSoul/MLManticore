...
static std::string Convolution3D_Kernel_Code = R"(


void kernel Convolution3D(global float* X, global float* K, global float* Y, int XSizeX, int XSizeY,int XSizeZ, int KSizeX, int KSizeY,int KSizeZ, int YSizeX, int YSizeY, int YSizeZ, int StrideX, int StrideY, int StrideZ, int PaddingX, int PaddingY,int PaddingZ)
{
...
static std::string Convolution3DBackProp_Kernel_Code = R"(


void kernel Convolution3DBackProp(global const float* X, global float* K, global float* ZPrime,global float* dY_dX, const int XSizeX, const int XSizeY, const int XSizeZ, const int KSizeX, const int KSizeY, const int KSizeZ, const int YSizeX, const int YSizeY, const int YSizeZ, const int StrideX, const int StrideY, const int StrideZ, const int PaddingX, const int PaddingY, const int PaddingZ)
{
int gid_x = get_global_id(0);
int gid_y = get_global_id(1);
int gid_z = get_global_id(2);
